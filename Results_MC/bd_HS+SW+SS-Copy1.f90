...
!!
	...
	rmin2=diam/dd+H-4.8682343911552517d-2*dlt
	rmin3=diam/dd+H+(1.d0-4.8682343911552517d-2)*dlt
	rmin4=rmin3+H2-d0
	rmax=dsqrt(100.d0/dk)+diam/dd+H+H2
	Write(*,*)rmin,diam/dd
	Write(*,*)rmin2,rmin3,rmin4,rmax
!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!
!!	Escalamiento
...
!!
	open(1,file='pot2.dat',status='unknown')
	Do i=1,10*nr
		rij=i*0.1d0*dr
		u11=uij(rij,aux)
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!     
	...
	open(10,file='conf_fin2.dat', status='unknown')
